        ...
        try:
            with get_connection() as conn:
                ...
                review_summary = self._generate_review_summary(
                    ts_code, monthly_return, max_drawdown, max_gain,
                    len(buy_signals), len(sell_signals),
                    correct_buy_signals, correct_sell_signals
                )
                
                # 生成经验教训
                lessons_learned = self._generate_lessons_learned(
                    ts_code, monthly_return, max_drawdown,
                    len(buy_signals), correct_buy_signals
                )
